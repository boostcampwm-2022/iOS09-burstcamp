...
public enum Assets {
  public enum Color {
    ...
    public static let brightGreen = ColorAsset(name: "brightGreen")
    public static let brightOrange = ColorAsset(name: "brightOrange")
    public static let brightYellow = ColorAsset(name: "brightYellow")
    ...
    public static let teal = ColorAsset(name: "teal")
